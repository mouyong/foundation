...
namespace Yan\Foundation\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('Foundation', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/foundation/foundation.log', $this->level(['level' => 'debug'])
        )]));
    }
    ...
    protected function createSyslogDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SyslogHandler(
                    'Foundation', $config['facility'] ?? LOG_USER, $this->level($config))
            ),
        ]);
    }
